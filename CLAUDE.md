...
<!-- FILL IN: PAGE_LIMIT = ___ pages, per the TPDS author guidelines in force. -->
...
<!-- FILL IN: confirm the current IEEE policy on disclosing generative-AI assistance
     (disclosure in the acknowledgments is required) and record the agreed wording here. -->
